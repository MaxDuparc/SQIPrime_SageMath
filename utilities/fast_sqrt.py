...
def sqrt_Fp4(x, zeta, well_def = False):
    """
    Fast computation of square-roots in SageMath using that p = 3 mod 4 in the case of supersingular elliptic curve
    """    
    F = x.parent()
    z = F.gen()
    p = F.characteristic()
