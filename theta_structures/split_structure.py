...
class SplitThetaStructure:
    ...
    def split(P):
        ...
        position, we can always obtain the dim-1 theta structure in the following
        way
    ...
    def __call__(self, P, zeta,lift=True):
        """ """
        ...
        if lift:
            ...
            Q1 = self.to_points(self.E1, Q1X, Q1Z, zeta)
            Q2 = self.to_points(self.E2, Q2X, Q2Z, zeta)
